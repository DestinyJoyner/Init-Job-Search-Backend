...
false,
'Writing new lines of code for programs that are currently in development. Collect feedback from users about the efficiency of the programs they help create.', 1),
('Full Stack Dev', 
'Citi', 'Los Angeles, CA', 
...
false,
'Writing new lines of code for programs that are currently in development. Collect feedback from users about the efficiency of the programs they help create.', 2),
('Web Editor', 
'Cisco', 
'Seattle, WA', 
...
true,
'Reviews the written content featured on websites and applications to ensure it''s accurate. Reading the text on an application closely to look for spelling or grammar errors. Using search engine optimization to verify that a website appears online.', 2),
...
false,
'Helps a development team to design and produce new software products. Write code at the request of higher-level developers. Conduct troubleshooting and bug fixes on software during the testing stage. Help developers adjust previously written code for new purposes.', 3),
...
true,
'Guide customers through the installation process for new software or applications. Perform troubleshooting when a user experiences challenges. Recommend new products to users who might benefit from updating their software or hardware.', 3),
...
true,
'Create and repeatedly run tests tests on applications to ensure they perform the desired functions. Frequently review the design specifications and expectations of each product.', 4),
...
false,
'Use the Java programming language to write new code. Testing the code you create to ensure it functions. Design applications for internet and intranet platforms.', 4),
...
false,
'Review the conditions of a piece of software to develop a test. Build new automation tests to assess an application''s performance. Identify any bugs that appear during the testing process.', 5),
...
false,
'Writing new lines of code for programs that are currently in development. Collect feedback from users about the efficiency of the programs they help create.', 5),
...
true,
'Writing new lines of code for programs that are currently in development. Collect feedback from users about the efficiency of the programs they help create.', 6)
;
