...
const { taskFormat, jobSchema } = require("../middleware/schemaValidations/jobValidation.js")
...
// CREATE
jobs.post("/", taskFormat, jobSchema, validationError, async (req, res) => {
...
// UPDATE
jobs.put("/:id", taskFormat, jobSchema, validationError, async (req, res) => {
  const { id } = req.params;
